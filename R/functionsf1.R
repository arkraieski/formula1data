...
#' @example aus_laps_2018 <- getLapsByRace(2018, 1)
...
#' @example vettel_laps_aus_2011 <- getDriverLaps(2011, 1, driverId = "vettel")
...
#' @param year a four digit integer
#' @param race a 1 or 2 digit integer indicating which round of the season
#' @example aus_pitstops_2018 <- getPitStopsByRace(2018, 1)
...
#' @param year a four digit integer
#' @param race a 1 or 2 digit integer indicating which round of the season
#' @example aus_results_2018 <- getRaceResults(2018, 1)
...
#' @param year a four digit integer
#' @param race a 1 or 2 digit integer indicating which round of the season
#' @example aus_qualy_2018 <- getQualifyingResults(2018, 1)
